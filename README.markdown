...
This package contains the Concrete5 blocks for [Cicero Live](https://live.cicerodata.com/) and the [upcoming elections](https://www.cicerodata.com/) feed.

Each block takes advantage of Azavea's [Cicero API](http://www.cicerodata.com/) for political data and elected-official lookups by street address.
...
Next, sign up for a 1,000 API credit / 90 day [free trial of Cicero](https://www.cicerodata.com/free-trial/). Each address lookup you perform from the Cicero Live block will count against these 1,000 credits. The Cicero Elections block does not cost any credits, but currently your free trial will still expire after 90 days. If you like Cicero, Azavea has affordable API-credit pricing starting at just $298 for 10,000 credits per year for government, non-profit, and education customers.
